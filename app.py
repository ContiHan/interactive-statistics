...
from modules import distributions, concepts, testing, regression, time_series_other, probability, operations_research, machine_learning
...
topics = [
    ...
    "Logistická regrese",
    "Bayesův teorém",
    "Neparametrické testy (Mann-Whitney)",
...
testing_topics = ["Chyba I. a II. druhu", "ANOVA", "Dvouvýběrový t-test", "Intervaly spolehlivosti", "Neparametrické testy (Mann-Whitney)"]
regression_topics = ["Lineární regrese", "Analýza reziduí", "Korelační analýza", "Logistická regrese"]
ts_other_topics = ["Dekompozice časové řady", "Stacionarita", "Q-statistika (Míra diverzity)", "Markovské řetězce"]
prob_topics = ["Bayesův teorém"]
or_topics = ["Lineární programování"]
ml_topics = ["Rozhodovací stromy"]
...
elif selected_topic in prob_topics:
    probability.render(selected_topic)
elif selected_topic in or_topics:
    operations_research.render(selected_topic)
elif selected_topic in ml_topics:
    machine_learning.render(selected_topic)
